...
function Demo(input) {
  ...
  let income = numberOfPuzzles * 2.6 + numbrOfTalkingDolls * 3 + numberOfTeddyBears * 4.1 + numberOfMinions * 8.2 + numberOfTrucks * 2;
  let numberOfOrderedToys = numberOfPuzzles + numbrOfTalkingDolls + numberOfTeddyBears + numberOfMinions + numberOfTrucks;
  let discount;
