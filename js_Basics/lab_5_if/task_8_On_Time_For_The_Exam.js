...
function Demo(input) {
  ...
  if (arrivalHour > examHour || (arrivalHour === examHour && arrivalMinute > examMinute)) {
    console.log('Late');
    ...
    } else if (examHour === arrivalHour && 60 + examMinute - arrivalMinute < 60) {
      resultMin = examMinute - arrivalMinute;
      console.log(`${resultMin} minutes before the start`);
    }
  } else if ((arrivalHour === examHour && examMinute >= arrivalMinute) || (arrivalHour < examHour && 60 + examMinute - arrivalMinute) <= 30) {
    console.log('On time');
