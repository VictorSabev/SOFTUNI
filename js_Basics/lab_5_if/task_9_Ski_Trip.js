...
function Demo(input) {
  ...
  if (typeOfRoom === 'apartment' && daysOfStay < 10) {
    discount = 0.3;
  } else if (typeOfRoom === 'apartment' && daysOfStay >= 10 && daysOfStay <= 15) {
    discount = 0.35;
  } else if (typeOfRoom === 'apartment' && daysOfStay > 15) {
    discount = 0.5;
  } else if (typeOfRoom === 'president apartment' && daysOfStay < 10) {
    discount = 0.1;
  } else if (typeOfRoom === 'president apartment' && daysOfStay >= 10 && daysOfStay <= 15) {
    discount = 0.15;
  ...
  let totalPrice = (subTotal - subTotal * additionalDiscount + subTotal * overprice).toFixed(2);
